...
RUN apt-get install -y php7.2 php7.2-common php7.2-cli php7.2-fpm php7.2-mysql php7.2-gd php7.2-soap php7.2-ldap php7.2-intl php7.2-xml php7.2-mbstring
